	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_9_0_g19297 = Base_Extras_RGB213_g18710;
				half sRGB8_g19297 = temp_output_9_0_g19297;
				half localGammaToLinearFloatFast8_g19297 = GammaToLinearFloatFast( sRGB8_g19297 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g19297 = temp_output_9_0_g19297;
				#else
				float staticSwitch1_g19297 = localGammaToLinearFloatFast8_g19297;
				#endif
				half3 appendResult209_g18710 = (half3(0.0 , staticSwitch1_g19297 , 0.0));
				...
				half4 break469_g18710 = saturate( ( ( tex2DNode17_g18710 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19287 ) ) );
				...
				half2 temp_output_851_0_g18710 = saturate( ( ( abs( (( (temp_output_35_0_g19293).zw + ( (temp_output_35_0_g19293).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19294 ) ) );
...
/*ASEBEGIN
Version=18909
1920;7;1906;1015;760.6006;1966.039;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;124;-256,-1536;Inherit;False;Define ELEMENT EXTRAS;47;;19304;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=214B97C6B6904B78D42C3A49A45A2D4C2C79E0C8