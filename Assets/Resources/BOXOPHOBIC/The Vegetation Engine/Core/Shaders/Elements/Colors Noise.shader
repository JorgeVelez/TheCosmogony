	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_7_0_g19295 = _NoiseMinValue;
				half4 lerpResult772_g19142 = lerp( _NoiseColorOne , _NoiseColorTwo , saturate( ( ( simpleNoise775_g19142 - temp_output_7_0_g19295 ) / ( _NoiseMaxValue - temp_output_7_0_g19295 ) ) ));
				...
				half2 temp_cast_0 = (temp_output_7_0_g19294).xx;
				half2 temp_output_851_0_g19142 = saturate( ( ( abs( (( (temp_output_35_0_g19293).zw + ( (temp_output_35_0_g19293).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g19294 ) ) );
				...
				half4 temp_cast_1 = (temp_output_7_0_g19287).xxxx;
				half4 break469_g19142 = saturate( ( ( tex2DNode17_g19142 - temp_cast_1 ) / ( _MainTexMaxValue - temp_output_7_0_g19287 ) ) );
...
/*ASEBEGIN
Version=18909
1920;7;1906;1015;1390.909;1301.683;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;108;-640,-768;Inherit;False;Define ELEMENT COLORS;48;;19304;378049ebac362e14aae08c2daa8ed737;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3489340B49646882CA4C0E80E0B2E5BA1C8A3A14