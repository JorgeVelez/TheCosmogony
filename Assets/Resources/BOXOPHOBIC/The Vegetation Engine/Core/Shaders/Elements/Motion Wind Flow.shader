	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 temp_cast_4 = (temp_output_7_0_g19294).xx;
				float2 temp_output_851_0_g18705 = saturate( ( ( abs( (( (temp_output_35_0_g19293).zw + ( (temp_output_35_0_g19293).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_4 ) / ( 1.0 - temp_output_7_0_g19294 ) ) );
...
/*ASEBEGIN
Version=18909
1920;7;1906;1015;1416.464;1763.379;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;117;-640,-1280;Inherit;False;Define ELEMENT MOTION;47;;19304;6eebc31017d99e84e811285e6a5d199d;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=203DA9A1F4174277E034962EC163D90A1A35AFAE