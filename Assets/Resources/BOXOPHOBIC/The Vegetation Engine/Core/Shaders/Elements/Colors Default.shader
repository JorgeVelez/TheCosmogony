	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 break469_g19248 = saturate( ( ( tex2DNode17_g19248 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19287 ) ) );
				...
				half2 temp_output_851_0_g19248 = saturate( ( ( abs( (( (temp_output_35_0_g19293).zw + ( (temp_output_35_0_g19293).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19294 ) ) );
...
/*ASEBEGIN
Version=18909
1920;7;1906;1015;1376.167;1109.816;1;True;False
...
ASEEND*/
//CHKSM=A3302B9FF5DC6840CB4C3466FD76C287E534A6F9