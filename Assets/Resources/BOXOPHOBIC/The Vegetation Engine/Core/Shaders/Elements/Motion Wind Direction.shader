	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 Colors37_g19297 = TVE_ColorsCoord;
				half4 Extras37_g19297 = TVE_ExtrasCoord;
				half4 Motion37_g19297 = TVE_MotionCoord;
				half4 React37_g19297 = TVE_ReactCoord;
				half4 localIS_ELEMENT37_g19297 = IS_ELEMENT( Colors37_g19297 , Extras37_g19297 , Motion37_g19297 , React37_g19297 );
				float4 temp_output_35_0_g19298 = localIS_ELEMENT37_g19297;
				float temp_output_7_0_g19299 = TVE_ElementsFadeValue;
				float2 temp_cast_0 = (temp_output_7_0_g19299).xx;
				float2 temp_output_851_0_g19293 = saturate( ( ( abs( (( (temp_output_35_0_g19298).zw + ( (temp_output_35_0_g19298).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_0 ) / ( 1.0 - temp_output_7_0_g19299 ) ) );
...
/*ASEBEGIN
Version=18909
1920;7;1906;1015;1652.441;1765.434;1;True;False
...
ASEEND*/
//CHKSM=628400C69DE608B6888AE2CE17568BEEB84A16AD