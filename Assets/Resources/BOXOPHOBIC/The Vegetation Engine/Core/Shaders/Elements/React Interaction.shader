	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g19311 = -ase_objectScale.x;
				half normalX_WS284_g19296 = ( ( temp_output_275_0_g19296.x - temp_output_7_0_g19311 ) / ( ase_objectScale.x - temp_output_7_0_g19311 ) );
				...
				float temp_output_7_0_g19306 = -ase_objectScale.z;
				half normalZ_WS285_g19296 = ( ( temp_output_275_0_g19296.z - temp_output_7_0_g19306 ) / ( ase_objectScale.z - temp_output_7_0_g19306 ) );
				...
				half4 Colors37_g19300 = TVE_ColorsCoord;
				half4 Extras37_g19300 = TVE_ExtrasCoord;
				half4 Motion37_g19300 = TVE_MotionCoord;
				half4 React37_g19300 = TVE_ReactCoord;
				half4 localIS_ELEMENT37_g19300 = IS_ELEMENT( Colors37_g19300 , Extras37_g19300 , Motion37_g19300 , React37_g19300 );
				float4 temp_output_35_0_g19301 = localIS_ELEMENT37_g19300;
				float temp_output_7_0_g19302 = TVE_ElementsFadeValue;
				float2 temp_cast_4 = (temp_output_7_0_g19302).xx;
				float2 temp_output_851_0_g19296 = saturate( ( ( abs( (( (temp_output_35_0_g19301).zw + ( (temp_output_35_0_g19301).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_4 ) / ( 1.0 - temp_output_7_0_g19302 ) ) );
...
/*ASEBEGIN
Version=18909
1920;7;1906;1015;1598.803;1668.291;1;True;False
...
ASEEND*/
//CHKSM=E06FA3CDFBA68B3E697615A1FE3509300058FF0C