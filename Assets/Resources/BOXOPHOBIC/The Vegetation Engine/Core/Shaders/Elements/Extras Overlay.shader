	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_9_0_g19299 = Base_Extras_RGB213_g18625;
				...
				#endif
				half3 appendResult239_g18625 = (half3(0.0 , 0.0 , staticSwitch1_g19299));
				...
				half4 break469_g18625 = saturate( ( ( tex2DNode17_g18625 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19287 ) ) );
				...
				half2 temp_output_851_0_g18625 = saturate( ( ( abs( (( (temp_output_35_0_g19293).zw + ( (temp_output_35_0_g19293).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19294 ) ) );
...
/*ASEBEGIN
Version=18909
1920;7;1906;1015;1354.536;1852.973;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;113;-640,-1408;Inherit;False;Define ELEMENT EXTRAS;47;;19304;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=AFA89766D1F14B5ED878777E743D2832461D4CFE