	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float temp_output_7_0_g19287 = _MainTexMinValue;
				float4 temp_cast_0 = (temp_output_7_0_g19287).xxxx;
				float4 break469_g18997 = saturate( ( ( tex2DNode17_g18997 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19287 ) ) );
				...
				float4 temp_output_35_0_g19293 = localIS_ELEMENT37_g19292;
				float temp_output_7_0_g19294 = TVE_ElementsFadeValue;
				float2 temp_cast_1 = (temp_output_7_0_g19294).xx;
				float2 temp_output_851_0_g18997 = saturate( ( ( abs( (( (temp_output_35_0_g19293).zw + ( (temp_output_35_0_g19293).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19294 ) ) );
...
/*ASEBEGIN
Version=18909
1920;7;1906;1015;1518.264;1811.589;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;129;-768,-1280;Inherit;False;Define ELEMENT REACT;0;;19304;9f8670cd8fdc98444822270656343d82;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BC3FAF688740283D5B28456245F8077779357CBB