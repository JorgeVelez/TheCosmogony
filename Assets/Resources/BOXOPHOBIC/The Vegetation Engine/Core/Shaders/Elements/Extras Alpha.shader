	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 break469_g18973 = saturate( ( ( tex2DNode17_g18973 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19287 ) ) );
				...
				half2 temp_output_851_0_g18973 = saturate( ( ( abs( (( (temp_output_35_0_g19293).zw + ( (temp_output_35_0_g19293).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19294 ) ) );
				...
				half temp_output_9_0_g19300 = lerpResult378_g18973;
				half sRGB8_g19300 = temp_output_9_0_g19300;
				half localGammaToLinearFloatFast8_g19300 = GammaToLinearFloatFast( sRGB8_g19300 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g19300 = temp_output_9_0_g19300;
				#else
				float staticSwitch1_g19300 = localGammaToLinearFloatFast8_g19300;
				#endif
				half Final_Alpha_A211_g18973 = staticSwitch1_g19300;
...
/*ASEBEGIN
Version=18909
1920;7;1906;1015;1293.946;1875.14;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;106;-640,-1408;Inherit;False;Define ELEMENT EXTRAS;47;;19304;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2AD8E55E200238163B9508468334ADDB024B688D